...
//       <div
//         className={` bg-gradient-to-b from-blue-50 to-blue-200 p-5  shadow-xl transition-transform duration-300 z-40 overflow-y-auto
//           ${
...
//         <Link
//           to="/"
//           className="font-extrabold text-3xl bg-blue-100 p-3 w-full rounded text-center  shadow-md hover:bg-blue-200 transition"
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-blue-50 to-blue-200 p-5 flex flex-col justify-between shadow-xl transition-transform duration-300 z-40 overflow-y-auto
          ${
            isOpen ? "translate-x-0" : "-translate-x-full"
          } md:translate-x-0 md:relative`}
      >
        ...
        <Link
          to="/"
          className="font-extrabold text-3xl bg-blue-100 p-3 w-full rounded text-center mb-10 shadow-md hover:bg-blue-200 transition"
          onClick={() => setIsOpen(false)}
        >
          ClubSphere
        </Link>
